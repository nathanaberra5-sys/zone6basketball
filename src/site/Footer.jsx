...
import { CONTACT_EMAIL, PHONE_DISPLAY, PHONE_TEL, INSTAGRAM_URL, INSTAGRAM_HANDLE } from "../config.js";
    ...
    <footer style={{ borderTop:"1px solid var(--border-subtle)", background:"var(--bg-deep)", padding:"54px 32px 40px" }}>
      <div style={{ maxWidth:1100, margin:"0 auto", display:"flex", justifyContent:"space-between",
        ...
        <div style={{ display:"flex", flexDirection:"column", gap:12, alignItems:"flex-start" }}>
          ...
          <a href={INSTAGRAM_URL} target="_blank" rel="noopener" style={linkStyle}><IgIcon /> {INSTAGRAM_HANDLE}</a>
